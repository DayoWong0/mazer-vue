            ...
            <div class="col-xl-4 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <img class="img-fluid w-100" src="../../assets/images/samples/banana.jpg" alt="Card image cap" v-lazy-load>
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="../../assets/images/samples/jump.jpg" class="d-block w-100" alt="Image Jump" v-lazy-load>
                                </div>
                            </div>
        ...
        <div class="row match-height">
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-top img-fluid" src="../../assets/images/samples/1.png" alt="Card image cap" v-lazy-load>
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-top img-fluid" src="../../assets/images/samples/3.png" alt="Card image cap" v-lazy-load>
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
                                <p class="card-text">
                                    This card has supporting text below as a natural lead-in to additional
                    ...
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-top img-fluid" src="../../assets/images/samples/4.png" alt="Card image cap" v-lazy-load>
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
                                <p class="card-text">
                                    This card has supporting text below as a natural lead-in to additional
